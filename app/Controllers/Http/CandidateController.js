...
const { getRadiusFilterResolver,multipleFilterParser, defaultWhereResolver, multipleWhereResolver, positionFilterResolver, applyOrderClause } = (use('App/Helpers/QueryFilteringUtil'));
...
class CandidateController {
  constructor() {
    ...
    this._filterOptionsColumnMap = {
      ...
      radius: {resolver: getRadiusFilterResolver({zipColumn: 'add.zip', coordsColumn: 'ca.coordinates'})},
    };
