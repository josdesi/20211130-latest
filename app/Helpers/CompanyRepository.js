...
const { auditFields, hiringAuthorityStatus, userRoles, companyType, EntityTypes, OperationType, DateFormats, activityLogTypes } = use('App/Helpers/Globals');
    ...
    try {
      ...
      if(dateUpdated){
        ...
        await Database.table('company_activity_logs')
          .where('id', companyActivityLog.id)
      ...
      if(activityLogTypeId === activityLogTypes.Call || activityLogTypeId === activityLogTypes.SMS){
        appInsights.defaultClient.trackEvent({
          ...
          properties: { companyId, userId, metadata, dateUpdated }
        });
      }
