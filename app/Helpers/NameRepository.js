...
const { auditFields, nameStatus, nameTypes, joinStringForQueryUsage, activityLogTypes } = use('App/Helpers/Globals');
...
class NameRepository {
  ...
  async createActivityLog(body, activity_log_type_id, name_id, user_id, optionalParams = {}) {
    ...
    try {
      ...
      if(activity_log_type_id === activityLogTypes.Call || activity_log_type_id === activityLogTypes.SMS){
        appInsights.defaultClient.trackEvent({
          name: 'Invalid phone act log',
          properties: { name_id, userId, metadata, dateUpdated }
        });
      }
