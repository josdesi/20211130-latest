...
//These were the most valid tags extracted from PCR Forms
//And when i say valid tags i mean the only mappable on FP
//There are several custom tags so in those cases a human intervention is required
const PCRSmarTagMap = {
  "[[Name.First_Name]]": 'first_name',
  "[[System.Current_User_Email_Signature]]": 'your_signature',
  "[[Name.User_Name]]": 'first_name',
  "[[Name.Last_Name]]": 'last_name',
  "[[System.User_Name]]": 'your_first_name',
  "[[Recipient.First_Name]]": 'first_name',
  "[[System.User_Full_Name]]": 'your_full_name',
  "[[Company.Company_Name]]":'company_name',
  "[[Name.User_Full_Name]]": 'full_name',
  "[[Name.City]]": 'city',
  "[[System.User]]": 'your_full_name',
  "[[System.Current_User]]": 'your_full_name',
  "[[Name.First Name]]": 'first_name',
  "[[First_Name]]": 'first_name',
  "[[Email Opt Out Link]]": 'remove_tag'
}
