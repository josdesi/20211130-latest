...
const { hiringAuthorityStatus, DateFormats, joinStringForQueryUsage } = use('App/Helpers/Globals');
   ...
   */
   async createActivityLog(body, activityLogTypeId, hiringAuthorityId, userId, optionalParams = {}) {
    ...
    try {
      ...
      if(dateUpdated){
        hiringAuthorityActivityLog.merge({ created_at: dateUpdated });
        await hiringAuthorityActivityLog.save(trx);
      }
