...
Event.on(EventTypes.Company.Created, ['Company.notifyOnCreation', 'Company.logChange', 'Company.updateHiringAuthoritiesDirectoryInformation', 'Company.updateCandidatesDirectoryInformation', 'Company.updateNamesDirectoryInformation', 'Company.updateSearchInformation', 'EmailValidation.validate']);
...
Event.on(EventTypes.Company.Updated, ['Company.logChange', 'Company.updateHiringAuthoritiesDirectoryInformation', 'Company.updateCandidatesDirectoryInformation', 'Company.updateNamesDirectoryInformation', 'Company.updateSearchInformation',]);
