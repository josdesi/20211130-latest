...
Event.on(EventTypes.JobOrder.Created, ['JobOrder.notifyOnCreation','JobOrder.notifyOnRecruiterAssigned', 'JobOrder.updateSearchInformation']);

Event.on(EventTypes.JobOrder.Updated, ['JobOrder.logChange', 'JobOrder.updateSearchInformation']);

Event.on(EventTypes.JobOrder.WhiteSheetUpdated, ['JobOrder.notifyOnStatusUpdate','JobOrder.logWhiteSheetUpdate','JobOrder.evaluateFreeGame', 'JobOrder.updateSearchInformation']);
