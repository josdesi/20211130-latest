  ...
  */
  files: {
    ...
    */
    processManually: [
      '/api/v1/files',
      '/api/v1/companies/:id/files',
      '/api/v1/candidates/:id/files',
      '/api/v1/hiring-authorities/:id/files',
      '/api/v1/job-orders/:id/files',
      '/api/v1/companies/:id/files',
      '/api/v1/names/:id/files',
      '/api/v1/migrations/search-projects',
      '/api/v1/fee-agreements/create-template-draft',
      '/api/v1/bulk-emails/attachment',
      '/api/v1/bulk-emails/image',
      '/api/v1/migrations/companies/:sourceId',
      '/api/v1/migrations/contacts/:sourceId',
      '/api/v1/migrations/contacts/:sourceId/forCompany/:companyId',
      '/api/v1/sendouts/attachments',
      '/api/v1/fee-agreements/temporary-file',
