  ...
  up() {
    this.schedule(async (transaction) => {
      try {
        ...
        const coachEmails = ['holly.bishop@gogpac.com', 'jarrad.emery@gogpac.com', 'darrin.tebeest@gogpac.com', 'greg.schouten@gogpac.com'];
        ...
        const permissionsDataRaw = recruiterIds.map((row) => {
          return { permission_id: userPermissions.sendout.usage, user_id: row.recruiter_id };
        });
