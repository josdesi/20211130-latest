...
class AddChannelPartnerOnUserViewSchema extends Schema {
  up () {
  ...
  down () {
    this.table('add_channel_partner_on_user_views', (table) => {
      // reverse alternations
    })
  }
}

module.exports = AddChannelPartnerOnUserViewSchema
