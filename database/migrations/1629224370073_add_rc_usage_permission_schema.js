...
class AddRcUsagePermissionSchema extends Schema {
  up() {
    this.schedule(async (transaction) => {
      try {
        ...
        const permissionsDataRaw = recruiterIds.map((row) => {
          return { permission_id: userPermissions.ringCentral.usage, user_id: row.recruiter_id };
        });
...
module.exports = AddRcUsagePermissionSchema
