...
const fileName = '(!Fil3W&ith#Char@ctersD$cod$d^!)ü,é,á,í,ó,ú,ñ,Ñ,¿,¡.png'
const relativePath = `attachments/${fileName}`;
const urlDecoded = `${azureUrlStorage}${relativePath}`
const urlEncoded = `${azureUrlStorage}attachments/(!Fil3W%26ith%23Char%40ctersD%24cod%24d%5E!)%C3%BC%2C%C3%A9%2C%C3%A1%2C%C3%AD%2C%C3%B3%2C%C3%BA%2C%C3%B1%2C%C3%91%2C%C2%BF%2C%C2%A1.png`
